...
const Jetskiing = () => {
  const fishingConditionsPercent = 43; 
  ...
  return (
    <div className="min-h-screen bg-gray-100">
       ...
       <div className="relative w-full h-64 md:h-96">
        <h1 className="absolute top-[150px] left-[60px] text-white text-[60px] font-bold z-10">Personal Water Craft - PWC</h1>
        <Image
          src="/images/Jetski-banner.jpg" 
          alt="Fishing"
          layout="fill"
          objectFit="cover"
      ...
      <div className="mx-auto h-[390px] px-[50px] py-2 grid md:grid-cols-11 gap-8">
        <div className="bg-white col-span-5 shadow-md rounded-lg p-1">
          <h2 className="text-xl pl-6 pt-4 text-start font-semibold text-gray-700">PWC Conditions</h2>
      ...
      <div className='w-full flex flex-row items-center justify-between'>
        ...
        <p className="text-3xl font-semibold text-gray-800">On the rougher side</p>
