  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-8">
      ...
      <div className="relative w-full h-64 md:h-96">
        <h1 className="absolute top-32 left-4 md:left-20 text-white text-2xl md:text-5xl font-bold z-10">Personal Water Craft - PWC</h1>
        <Image
