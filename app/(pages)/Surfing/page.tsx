...
import { FaStar, FaSearch, FaArrowLeft, FaArrowDown, FaArrowUp, FaWater, FaRegCalendarAlt } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-[60px]">
       ...
       <div className="relative w-full h-64 md:h-96">
        <h1 className="absolute top-4 left-[60px] text-white text-[60px] font-bold z-10">Surfing</h1>
        <Image
      ...
      <div className="mx-auto h-[600px] px-[50px] py-2 grid md:grid-cols-12 gap-8">
        <div className="bg-white col-span-8 shadow-md rounded-lg p-1">
          <h2 className="text-3xl pl-6 pt-4 text-start font-semibold text-gray-700">Surfing Conditions</h2>
          ...
          <h1 className='text-green-600 pl-6 pt-6 text-start text-[40px] font-bold'>EXCELLENT</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-[40px] p-[50px]">
        ...
        <div className="bg-green-100 p-3 rounded-lg text-start shadow-md flex flex-col justify-between">
          ...
          <p className="text-sm text-green-600 flex flex-row items-center gap-1"><FaArrowUp color='green'/> 0.5m, +3s</p>
        </div>
