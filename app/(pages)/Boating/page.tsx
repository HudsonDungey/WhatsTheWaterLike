    ...
    <div className="min-h-screen bg-gray-100 pb-[60px]">
      ...
      <div className="mx-auto h-[600px] px-[50px] py-2 grid md:grid-cols-12 gap-8">
        <div className="bg-white col-span-8 shadow-md rounded-lg p-1">
          <h2 className="text-3xl pl-6 pt-4 text-start font-semibold text-gray-700">Boating Conditions</h2>
          ...
          <h1 className='text-green-600 pl-6 pt-6 text-start text-[40px] font-bold'>FAIR</h1>
        ...
        <div className="bg-white col-span-4 shadow-md rounded-lg p-4 flex flex-col space-y-4">
          <button
