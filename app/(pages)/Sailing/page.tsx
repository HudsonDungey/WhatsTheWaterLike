...
const Sailing = () => {
  const fishingConditionsPercent = 63; 
  ...
  return (
    <div className="min-h-screen bg-gray-100">
       ...
       <div className="relative w-full h-64 md:h-96">
        <h1 className="absolute top-4 left-[60px] text-white text-[60px] font-bold z-10">Sailing</h1>
        <Image
      ...
      <div className="mx-auto h-[390px] px-[50px] py-2 grid md:grid-cols-11 gap-8">
        <div className="bg-white col-span-5 shadow-md rounded-lg p-1">
          <h2 className="text-xl pl-6 pt-4 text-start font-semibold text-gray-700">Sailing Conditions</h2>
      ...
      <div className="flex items-center justify-between pb-2">
        <h2 className="text-lg font-semibold text-black"> Sailing Locations</h2>
      ...
      <div className='w-full flex flex-row items-center justify-between'>
        ...
        <p className="text-3xl font-semibold text-gray-800">Good For Sailing</p>
        <div className="mt-4 flex justify-end text-sm text-gray-500">
          <span>14 kts</span> / <span>26 kmh</span>
        </div>
      </div>
      ...
      <div className='w-full flex flex-row items-center justify-between'>
        ...
        <p className="text-3xl font-semibold text-gray-800">Cloudy but hot</p>
        <div className="mt-4 flex justify-end text-sm text-gray-500">
          <span>Max: 35°C</span> / <span>Min: 28°C</span>
        </div>
      </div>
