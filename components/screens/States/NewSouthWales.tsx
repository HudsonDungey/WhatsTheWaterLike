...
export const NewSouthWales: React.FC = () => {
    ...
    const fetchWeatherData = async () => {
      try {
        const response = await fetch(
          `https://api.worldweatheronline.com/premium/v1/marine.ashx?key=${process.env.NEXT_PUBLIC_WWW_API_KEY}&q=Sydney&format=json`
        );
